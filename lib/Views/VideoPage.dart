...
class AssetVideoWidget extends StatefulWidget {
  @override
  _AssetVideoWidgetState createState() => _AssetVideoWidgetState();
}
...
class _AssetVideoWidgetState extends State<AssetVideoWidget> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/images/microbiome.mp4');
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            height: context.isMobile?context.screenHeight*0.4:context.screenHeight*0.6,
