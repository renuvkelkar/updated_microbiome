...
class DType2 extends StatefulWidget {
  const DType2({Key key}) : super(key: key);

  @override
  _DType2State createState() => _DType2State();
}

class _DType2State extends State<DType2>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Type II Diabetes";
               ...
               VxBox(
                 child: Column(
                   children: [
                     ...
                     // Text("Protozoa ").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text1"].value),
                     Image.asset("assets/images/diabetis1.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     Text("Type II Diabetes").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
