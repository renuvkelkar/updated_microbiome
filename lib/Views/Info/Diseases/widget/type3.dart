...
class DType3 extends StatefulWidget {
  const DType3({Key key}) : super(key: key);

  @override
  _DType3State createState() => _DType3State();
}

class _DType3State extends State<DType3>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Irritable Bowel Syndrome (IBS)";
               ...
               VxBox(
                 child: Column(
                   children: [
                     ...
                     // Text("Viruses  ").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text1"].value),
                     Image.asset("assets/images/stomach.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     Text("Irritable Bowel Syndrome (IBS)").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
