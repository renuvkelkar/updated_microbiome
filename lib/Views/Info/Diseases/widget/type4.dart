...
class DType4 extends StatefulWidget {
  const DType4({Key key}) : super(key: key);

  @override
  _DType4State createState() => _DType4State();
}

class _DType4State extends State<DType4>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Heart Disease";
               ...
               VxBox(
                 child: Column(
                   children: [
                    ...
                    // Text("Bacteria").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text1"].value),
                     Image.asset("assets/images/heart.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     Text("Heart Disease").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
