...
class SuperSlide2 extends StatefulWidget {
  const SuperSlide2({Key key}) : super(key: key);

  @override
  _SuperSlide2State createState() => _SuperSlide2State();
}

class _SuperSlide2State extends State<SuperSlide2>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Playing in a garden";
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       // Text("We can get these germs superpowers by:").text.size(context.isMobile?25:30).semiBold.white.makeCentered().p8().opacity(value: sequenceAnimation["text1"].value),
                        Image.asset("assets/images/outsideplay.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                        10.heightBox,
                        Text("Play in the garden").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
