...
class SuperSlide5 extends StatefulWidget {
  const SuperSlide5({Key key}) : super(key: key);

  @override
  _SuperSlide5State createState() => _SuperSlide5State();
}

class _SuperSlide5State extends State<SuperSlide5>with SingleTickerProviderStateMixin {
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       // Text("We can get these germs superpowers by:").text.size(context.isMobile?25:30).semiBold.white.makeCentered().p8().opacity(value: sequenceAnimation["text1"].value),
                        Image.asset("assets/images/yoga.png",height:context.screenHeight*0.5,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                        Text("Exercising").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
