...
class SuperPowerMicro extends StatefulWidget {
  const SuperPowerMicro({Key key}) : super(key: key);

  @override
  _SuperPowerMicroState createState() => _SuperPowerMicroState();
}

class _SuperPowerMicroState extends State<SuperPowerMicro> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Colors.lightBlue,
        appBar: AppBar(
          title: Text("Gaining Superpower"),
          centerTitle: true,
          actions: [
        ...
        body: VxBox(
          child: VxSwiper(
           ...
           // autoPlay: true,
            items: [
              VxBox(
                  child: SuperSlide1()).makeCentered(),
