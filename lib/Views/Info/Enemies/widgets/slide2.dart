...
class EnemySlide2 extends StatefulWidget {
  const EnemySlide2({Key key}) : super(key: key);

  @override
  _EnemySlide2State createState() => _EnemySlide2State();
}

class _EnemySlide2State extends State<EnemySlide2>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Eat junk or processed food";
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       // Text("1").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text1"].value),
                        Image.asset("assets/images/junk.png",height:context.screenHeight*0.4,width:context.screenWidth*0.8,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value).box.height(context.screenHeight*0.65).make(),
                        10.heightBox,
                        Text("Eat junk or processed food").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
