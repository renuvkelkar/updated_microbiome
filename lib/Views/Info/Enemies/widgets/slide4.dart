...
class EnemySlide4 extends StatefulWidget {
  const EnemySlide4({Key key}) : super(key: key);

  @override
  _EnemySlide4State createState() => _EnemySlide4State();
}

class _EnemySlide4State extends State<EnemySlide4>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Take too many medicines";
                ...
                VxBox(
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.network("https://image.freepik.com/free-vector/pills-medical-realistic-composition_98292-1233.jpg",height:context.screenHeight*0.4,width:context.screenWidth*0.8,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value).box.height(context.screenHeight*0.65).make(),
                        10.heightBox,
                        Text("Take too many medicines").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
