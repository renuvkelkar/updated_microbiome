...
class EnemySlide5 extends StatefulWidget {
  const EnemySlide5({Key key}) : super(key: key);

  @override
  _EnemySlide5State createState() => _EnemySlide5State();
}

class _EnemySlide5State extends State<EnemySlide5>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "if you Don’t exercise";
                ...
                VxBox(
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset("assets/images/tv.png",height:context.screenHeight*0.4,width:context.screenWidth*0.8,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value).box.height(context.screenHeight*0.65).make(),
                        10.heightBox,
                        Text("Don’t exercise").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
