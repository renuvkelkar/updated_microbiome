...
class _Type5State extends State<Type5>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Fungi in our gut help us fight infections.";
               ...
               VxBox(
                 child: Column(
                   ...
                   children: [
                     ...
                     Image.asset("assets/images/virus.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     10.heightBox,
                     Text("Fungi in our gut help us fight infections.").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
