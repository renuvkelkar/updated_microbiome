...
class _Type2State extends State<Type2>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Protozoa help bring good gut bacteria.";
               ...
               VxBox(
                 child: Column(
                   children: [
                     ...
                     Image.asset("assets/images/virus2.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     Text("Protozoa help bring good gut bacteria.").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
