                              ...
                              children: [
                                  ...
                                  children: [
                                    VxBox(
                                      // backgroundColor: Colors.orange,
                                        child: Image.asset("assets/images/bat1.png",height:50,width:50,fit: BoxFit.fill,)).roundedFull.green400.height(context.isMobile?80:150).width(context.isMobile?80:150).p16.make().opacity( value: sequenceAnimation["fungi"].value),
                                ...
                                Column(
                                  children: [
                                    VxBox(
                                      // backgroundColor: Colors.orange,
                                        child: Image.asset("assets/images/bat5.png",height:50,width:50,fit: BoxFit.fill,)).roundedFull.orange400.height(context.isMobile?80:150).width(context.isMobile?80:150).p16.make().opacity( value: sequenceAnimation["Protozoa"].value),
                                ...
                                Column(
                                  children: [
                                    VxBox(
                                      // backgroundColor: Colors.orange,
                                        child: Image.asset("assets/images/bat4.png",height:50,width:50,fit: BoxFit.fill,)).roundedFull.yellow400.height(context.isMobile?80:150).width(context.isMobile?100:150).p16.make().opacity( value: sequenceAnimation["virus"].value),
                                ...
                                Column(
                                  children: [
                                    VxBox(
                                      // backgroundColor: Colors.orange,
                                        child: Image.asset("assets/images/bat2.png",height:50,width:50,fit: BoxFit.fill,)).roundedFull.red400.height(context.isMobile?80:150).width(context.isMobile?80:150).p20.make().opacity( value: sequenceAnimation["bacteria"].value),
