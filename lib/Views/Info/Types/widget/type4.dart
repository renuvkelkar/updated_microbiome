...
class _Type4State extends State<Type4>with SingleTickerProviderStateMixin {
  AnimationController controller;
  SequenceAnimation sequenceAnimation;
  bool isSpeaking = false;
  final FlutterTts flutterTts = FlutterTts();
  String des= "Bacteria in our gut help digest our food.";
               ...
               VxBox(
                 child: Column(
                   children: [
                     ...
                     Image.asset("assets/images/body2.png",height:context.screenHeight*0.6,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
                     Text("Bacteria in our gut help digest our food.").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text2"].value),
