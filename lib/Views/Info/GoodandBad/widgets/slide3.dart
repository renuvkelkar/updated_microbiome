...
class _Slide3State extends State<Slide3>with SingleTickerProviderStateMixin {
  ...
  String des= "A Bad microbiome has very few types of germs that are like only some types of workers who cannot do all the jobs in our body.";
                ...
                VxBox(
                    child: Column(
                      children: [
                        ...
                        Text("What is a Bad Microbiome?").text.size(context.isMobile?25:30).semiBold.white.make().p8().opacity(value: sequenceAnimation["text1"].value),
                        Image.asset("assets/images/goodbact.png",height:context.screenHeight*0.4,width:context.screenWidth,fit: BoxFit.contain,).opacity(value: sequenceAnimation["image1"].value),
